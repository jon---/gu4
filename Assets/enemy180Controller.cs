...
public class enemy180Controller : MonoBehaviour {

	//public
	public Sprite enemy180_0;	//enemy180 main
	public Sprite enemy180_1;	//enemy180 open1
	public Sprite enemy180_2;	//enemy180 open2
	public Sprite enemy180_3;	//enemy180 open3
	...
	const float yspdbase = 0.19f;
	//base hit point
	const int basehitpoint = 10;
	//score
	readonly int hitscore = 20;
	readonly int score = 860;
	...
	void Update () {
		...
		if (intervalCnt >= 1) {
			...
			if (bcnt == 0) {
				...
				tposy = ppos.y + 5.8f + (Mathf.Sin (tposdir * Mathf.Deg2Rad) * 1.0f * tpossize);
			...
			if (bcnt >= 1) {
				bcnt++;
				if (bcnt == seqbase * 1) {
					sr.sprite = enemy180_1;
				} else if (bcnt == seqbase * 2) {
					sr.sprite = enemy180_2;
				} else if (bcnt == seqbase * 3) {
					sr.sprite = enemy180_3;
				} else if (bcnt == seqbase * 4) {
					float bspd = 0.8f;
				...
				} else if (bcnt == seqbase * 6) {
					sr.sprite = enemy180_2;
				} else if (bcnt == seqbase * 7) {
					sr.sprite = enemy180_1;
